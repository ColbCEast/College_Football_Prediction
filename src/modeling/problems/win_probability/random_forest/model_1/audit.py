"""
Random Forest Model 1 — Diagnostic / Stability Audit

Audits the trained Random Forest Model 1 for the win-probability problem.

Model:
    models/win_probability/random_forest/model_1/model.joblib

Input data:
    data/processed/model_inputs/win_probability/

Audit outputs:
    models/win_probability/random_forest/model_1/audit/
...
Important:
    ...
    - The saved model is the complete preprocessing + Random Forest pipeline.
"""
...
def load_data():
    ...
    the model has already been trained. It is loaded only for structural
...
def calculate_feature_importance(
    ...
    """
    Extract impurity-based feature importance from the Random Forest.
    """
...
def classify_feature(
    ...
    us to understand where the Random Forest is obtaining predictive signal.
    """
...
def calculate_family_importance(
    ...
    """
    Aggregate Random Forest impurity importance by feature family.
    """
...
def main():
    ...
    print()
    print("=" * 80)
    print("RANDOM FOREST MODEL 1 — DIAGNOSTIC / STABILITY AUDIT")
    print("=" * 80)
    ...
    print()
    print("=" * 80)
    print("RANDOM FOREST MODEL 1 AUDIT COMPLETE")
    print("=" * 80)
