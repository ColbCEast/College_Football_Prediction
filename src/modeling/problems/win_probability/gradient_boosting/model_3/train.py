...
Purpose
-------
Train a compact Gradient Boosting model using the same core feature set as
Gradient Boosting Model 2, but WITHOUT the engineered Trend and prior
...
All Gradient Boosting hyperparameters, temporal splits, preprocessing,
...
#
# These are retained explicitly so the experiment documents exactly
...
def main():
    ...
    print_section(
        "GRADIENT BOOSTING MODEL 3 — TRAINING COMPLETE"
    )
