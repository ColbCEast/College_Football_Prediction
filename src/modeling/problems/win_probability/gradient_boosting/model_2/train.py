"""
Train Gradient Boosting Model 2
================================

Purpose
-------
Train a compact Gradient Boosting model using a substantially smaller feature
set than Gradient Boosting Model 1.
...
def main():
    ...
    print_section(
        "GRADIENT BOOSTING MODEL 2 — TRAINING COMPLETE"
    )
